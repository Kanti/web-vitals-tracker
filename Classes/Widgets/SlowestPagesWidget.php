...
final class SlowestPagesWidget implements WidgetInterface
{
    ...
    {
        $this->view->setTemplate('Widget/SlowestPages');
        $averageLcp = $this->analyticalRepository->getAverages(null)['lcp'] ?? 0.0;
        $data = $this->analyticalRepository->getPagesOrderedByLcp('DESC');
